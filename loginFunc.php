                ...
                <div class="py-4 px-5 rounded">
                    <form method="post">
                        <div class="form-label-group mb-3 justify-content-center align-items-start d-flex flex-column">
                            <label for="loginIdent"><h5>Identificação</h5></label>
                            <input type="text" size="40" id="loginIdent" name="loginIdent" class="form-control" placeholder="CPF do Utilizador" maxlength="11" required autofocus>
                        </div>
                        <div class="form-label-group mb-3 justify-content-center align-items-start d-flex flex-column">
                            <label for="loginSenha"><h5>Senha</h5></label>
                            <input type="password" id="loginSenha" name="loginSenha" class="form-control" maxlength="15" placeholder="Senha" required>
                        ...
                        <div class="form-label-group mb-3 justify-content-center align-items-end d-flex flex-column">
                            ...
                            <small>É aluno? Clique <a href="index.php">AQUI</a>!</small>
                        </div>
                    </form>
                    <?php
                        if(isset($_POST['loginIdent']) && isset($_POST['loginSenha'])){
                            loginFunc();
                        }
                    ?>
                </div>
