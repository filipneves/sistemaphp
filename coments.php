        ...
        <div class="box-home container-fluid d-flex flex-column justify-content-center align-items-center">
            <div class="box-logged btn-block">
                ...
                <div class="p-4 d-flex justify-content-center flex-column align-items-center">
                    <?php 
                        $sql_show = "SELECT cpf, nome, matricula FROM alunos WHERE turma = '$turma' ORDER BY nome asc";
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <?php foreach($alunos as $a): ?>
                                        <tr>
                                            ...
                                            <td><a href="coments2.php?m=<?= $a['matricula'] ?>" class="btn btn-success">Ver/Gerenciar Comentários</a></td>
                                        <tr>
                                    <?php endforeach; ?>
                                </table>    
                            </div>  
